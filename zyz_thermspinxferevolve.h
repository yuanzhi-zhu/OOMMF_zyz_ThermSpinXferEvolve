/* FILE: zyz_thermspinxferevolve.h                  -*-Mode: c++-*-
 *
...
#ifndef _ZYZ_THERMSPINXFEREVOLVE
#define _ZYZ_THERMSPINXFEREVOLVE
...
class zyz_ThermSpinXferEvolve:public Oxs_TimeEvolver {
private:
  ...
  Oxs_OwnedPointer<Oxs_ScalarField> Therm_init;
  mutable Oxs_MeshValue<OC_REAL8m> Therm;
  ...
  **/
  ...
  Oxs_ScalarOutput<zyz_ThermSpinXferEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<zyz_ThermSpinXferEvolve> dE_dt_output;
  Oxs_ScalarOutput<zyz_ThermSpinXferEvolve> delta_E_output;
  Oxs_ScalarOutput<zyz_ThermSpinXferEvolve> temperature_output;
  Oxs_ScalarOutput<zyz_ThermSpinXferEvolve> ave_J_output;

  Oxs_VectorFieldOutput<zyz_ThermSpinXferEvolve> Therm_output;
  Oxs_VectorFieldOutput<zyz_ThermSpinXferEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<zyz_ThermSpinXferEvolve> mxH_output;
  Oxs_VectorFieldOutput<zyz_ThermSpinXferEvolve> spin_torque_output;
  Oxs_VectorFieldOutput<zyz_ThermSpinXferEvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((zyz_ThermSpinXferEvolve::* rkstep_ptr));
  ...
  zyz_ThermSpinXferEvolve(const zyz_ThermSpinXferEvolve&);
  zyz_ThermSpinXferEvolve& operator=(const zyz_ThermSpinXferEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  zyz_ThermSpinXferEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~zyz_ThermSpinXferEvolve();
...
#endif // _zyz_THERMSPINXFEREVOLVE
